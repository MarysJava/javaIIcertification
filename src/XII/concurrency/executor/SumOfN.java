...
class SumOfN {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < NUM_THREADS; i++) {
			// create a summation task starting from (10 * 0) + 1 .. (N/10 * 1) to (10 * 9) + 1 .. (N/10 * 10)
		...
		// print the sum using formula and the ones calculated one by one they must be equal!
