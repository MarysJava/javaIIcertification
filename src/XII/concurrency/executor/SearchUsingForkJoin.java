...
class SearchUsingForkJoin {
	...
	// This is the recursive implementation of the algorithm inherit from RecursiveAction
	static class SearchTask extends RecursiveAction {
		...
		public void compute() {
			...
			if ((to - from) <= N / NUM_THREADS) {
				...
				// so fork the computation we find the mid-point value in the range from..to
				int mid = (from + to) / 2;
	...
	public static void main(String[] args) {
		// instantiate the array to be searched
