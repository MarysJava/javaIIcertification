...
//Factorial implements Callable so that it can be passed to a ExecutorService and get executed as a task.
...
class CallableTest {
	public static void main(String[] args) throws Exception {
		...
		// create an ExecutorService with a fixed thread pool consisting of one
		// thread
